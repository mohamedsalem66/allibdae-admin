...
// Replace full refetch with direct state updates:
                    ...
                    <div className="relative p-4 sm:p-6 h-full overflow-y-auto max-h-screen">
                        ...
                        {prescriptionLoading && (
                            <div className="flex justify-center py-4">
                                <div className="w-8 h-8 border-4 border-blue-light-500 border-t-transparent rounded-full animate-spin" />
                            </div>
                        )}
    ...
    return (
        <>
            ...
            <Modal
                isOpen={isCnamModalOpen}
                onClose={closeCnamModal}
                className="max-w-md p-6"
            >
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                    {t("Add CNAM Information")}
                </h3>
                <div className="space-y-4">
                    <Input
                        type="text"
                        ...
                        error={cnamErrors.nni}
                    />
                    {cnamErrors.nni && (
                        <p className="text-xs text-error-600 dark:text-error-400">
                            {t("Invalid NNI (10 digits required)")}
                        </p>
                    )}
                </div>
                <div className="flex items-center justify-end gap-3 mt-6">
                    <Button variant="outline" size="sm" onClick={closeCnamModal}>
                        {t("Cancel")}
                    </Button>
                    <Button size="sm" onClick={handleAddCnam}>
                        {t("Submit")}
                    </Button>
                </div>
            </Modal>
            ...
            >
                ...
                <div className="space-y-4">
                    <textarea
                        ...
                        rows={4}
                        className="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm font-medium transition-all duration-200 placeholder:text-gray-400 focus:border-blue-light-500 focus:ring-2 focus:ring-blue-light-500/20 disabled:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-light-400"
                    />
                    {noteErrors.note && (
                        <p className="text-xs text-error-600 dark:text-error-400">{t("Note is required")}</p>
                    )}
                </div>
                <div className="flex items-center justify-end gap-3 mt-6">
                ...
                {orderCounts.map(({status, count}) => {
                    const statusConfig = {
                        ...
                        CONSTRUCTED: {
                            ...
                            bgColor: "bg-blue-light-100 dark:bg-blue-light-800",
                            textColor: "text-blue-light-600 dark:text-blue-light-300",
          ...
          <span className={config.textColor}>
                                            ...
                                            {order.status === "CONFIRMED" && (
                                                <button
                                                    ...
                                                    className={`inline-flex items-center justify-center gap-2 rounded-md border border-transparent px-3 py-1.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                                                        updatingStatus === order.id
                                                            ? "bg-transparent text-gray-500 cursor-not-allowed"
                                                            : "bg-blue-light-500 text-white hover:bg-blue-light-600 focus:ring-blue-light-500"
                                                    }`}
                                                >
                                                    {updatingStatus === order.id ? (
                                                        <div
            ...
            ${updatingContacted === order.id
                                                            ...
                                                            : 'bg-blue-light-50 text-blue-light-700 hover:bg-blue-light-100'}`}
                                                    >
                                                        {updatingContacted === order.id ? (
                                                            <div className="w-4 h-4 border-2 border-blue-light-500 border-t-transparent
                                        ...
                                        <div className="flex items-center space-x-3 jus">
                                            {
                                                order && (
                                                    <div>
                                                        ...
                                                        <label className="cursor-pointer text-blue-light-500 hover:text-blue-light-700">
                                                            <input
                                                                type="file"
                                                                accept="image/*"
                                                                className="hidden"
                                                        ...
                                                        {order.hasCnam ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex items-center  px-1.5 py-1.5 bg-blue-light-50 text-blue-light-700
                rounded-md hover:bg-blue-light-100 transition-colors mt-5"
                                                            >
                                    ...
                                    </div>
                                    {
                                        !order.note ? (
                                            <button
                                                ...
                                                className="mt-2 inline-flex items-center px-4 py-2 rounded-md bg-blue-light-50 text-blue-light-700 hover:bg-blue-light-100 transition-colors"
                                            >
                                                <svg
                                        ...
                                        <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                                            {order.hasCnam ? (
                                                ...
                                                <button
                                                   onClick={() => openCnamModal(order.id)}
                                                    className="flex items-center  px-1.5 py-1.5 bg-blue-light-50 text-blue-light-700
                rounded-md hover:bg-blue-light-100 transition-colors"
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                        <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                                                    </svg>
