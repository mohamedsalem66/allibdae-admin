...
const Badge: React.FC<BadgeProps> = ({
  ...
  const variants = {
    light: {
      ...
      ready: "bg-blue-light-50 text-blue-light-600 dark:bg-blue-light-500/15 dark:text-blue-light-400",
    ...
    solid: {
      ...
      ready: "bg-blue-light-500 text-white dark:bg-blue-light-500",
