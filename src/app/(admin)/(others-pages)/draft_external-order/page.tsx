                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        >
                            ...
                            <option value="null">{isRTL ? "الإبداع للنظارات" : "Allibdae Optique"}</option>
                            {allOptics.map((optic) => (
    ...
    <span className="z-10 relative flex items-center justify-center gap-1.5">
      <UserIcon className="w-4 h-4"/>
        {t("Client")}
                                                    ...
                                                    {activeTab === 'client' && (
                                                        <span
                                                            className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4/5 h-0.5 bg-blue-light-500 rounded-full animate-underline"></span>
                                                    )}
                                                </button>
                                                    ...
                                                    <div className="mt-2">
                                                        ...
                                                        <div className="flex items-center mt-2">
                                                            ...
                                                            <Switch
                                                                ...
                                                                className={`
                          ${hasAddForNewCategory ? 'bg-blue-light-600 dark:bg-blue-light-500' : 'bg-gray-200 dark:bg-gray-600'}
                                                ...
                                                <div
                                                    ...
                                                    <div className="flex justify-between items-center mb-3">
                                                        ...
                                                        <Switch
                                                            ...
                                                            className={`
                        ${newOrderData.rightEyeEnabled ? 'bg-blue-light-600 dark:bg-blue-light-500' : 'bg-gray-200 dark:bg-gray-600'}
                        relative inline-flex h-6 w-11 items-center rounded-full
                      `}
                                                        >
                      <span
                                                ...
                                                <div
                                                    ...
                                                    <div className="flex justify-between items-center mb-3">
                                                        ...
                                                        <Switch
                                                            ...
                                                            className={`
                        ${newOrderData.leftEyeEnabled ? 'bg-blue-light-600 dark:bg-blue-light-500' : 'bg-gray-200 dark:bg-gray-600'}
                        relative inline-flex h-6 w-11 items-center rounded-full
                      `}
                                                        >
                      <span
