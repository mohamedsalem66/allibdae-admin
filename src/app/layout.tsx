...
export default function RootLayout({
    ...
    useEffect(() => {
        document.title = "Allibdae Optique";
    }, []);
    ...
    if (isLoading) {
        return (
            ...
            <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
                <div
                    className="w-16 h-16 border-4 border-t-4 border-gray-200 dark:border-gray-700 border-t-blue-light-500 rounded-full animate-spin"
                ></div>
            </div>
            </body>
            </html>
